package com.malixi.spring.myzuul.utils;

import com.malixi.spring.myzuul.common.TokenStatus;
...
public class JwtUtil {
    ...
    private String generateToken(Map<String, Object> claims) {
        return Jwts.builder()
                .setClaims(claims)
                .setExpiration(this.generateExpirationDate()) // 过期时间
                .setIssuedAt(this.generateCurrentDate()) //签发时间
    ...
    public static void main(String[] args) {
        ...
        String token = jwtUtil.generateToken("111");
