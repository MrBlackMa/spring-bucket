package com.malixi.spring.myzuul.common;
...
public final class JSONResponse<T> {
     ...
     * 服务执行异常时的响应码
     */
    private static final int INFO_CODE = 4001;
    ...
    public static JSONResponse info(String message) {
        return new JSONResponse(INFO_CODE, message);
    }
